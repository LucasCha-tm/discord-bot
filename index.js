...
bot.on("ready", async () => {
    ...
    const channel = bot.channels.cache.get("877484485027958804") //Bot lancé !
  ...
  let statuses = [
    "en dev",//Statut du bot, EP 2 pour voir serveurs/membres
  ]
...
bot.login(process.env.ODU5MDk2NDE3MDYxNTY4NTYz.YNnt4w.WdJIvhbEKOznAuN2kWLAuvqkwow) //Token du bot